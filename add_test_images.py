#!/usr/bin/env python3
"""
Add new test images to test auto-sync functionality
"""
...
# Get the placeholder images directory
...
def create_image_with_metadata(image_num):
    ...
    # Create metadata
    workflow, prompt = create_comfyui_metadata()
...
def main():
    ...
    print(f"🎨 Generating 5 new images starting from #{start_num}...\n")

    # Generate 5 new images
    for i in range(5):
        create_image_with_metadata(start_num + i)

    print(f"\n✨ Successfully added 5 new images!")
    print(f"📁 Total images: {len(existing_images) + 5}")
